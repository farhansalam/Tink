...
vc_map(array(
   ...
   "params" 	=> array(
		...
		array(
			...
			"param_name"	=> "id",
			"value"			=> "",
			"description" => "Only enter 1 Product ID"
		),
		array(
			"type" => "checkbox",
			"class" => "",
			"heading" => "Display Product Title?",
			"param_name" => "title",
			"value" => array(
				"" => "true"
			),
			"description" => "If you want to show the product titl, enable this"
		),
		array(
			"type" => "checkbox",
			"class" => "",
			"heading" => "Display Product Price?",
			"param_name" => "price",
			"value" => array(
				"" => "true"
			),
			"description" => "If you want to show the price, enable this"
		),
		array(
			"type" => "dropdown",
			"class" => "",
...
vc_map( array(
	...
	"description" => "Add WooCommerce Product Category Grids"
) );