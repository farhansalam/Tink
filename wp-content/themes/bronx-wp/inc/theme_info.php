...
<div class="wrap">
    ...
    <h2><?php _e( 'Theme Info' , 'bronx' ); ?></h2>
	<h3 class="title"><?php _e( 'Please paste down these information when starting a support inquiry in our support forum' , 'bronx' ); ?></h3>
