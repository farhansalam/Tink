...
if ( $attachment_ids ) {
	...
	?>
	<div id="product-thumbnails" class="carousel slick product-thumbnails" data-center="true" data-navigation="false" data-autoplay="false" data-columns="<?php echo $size;?>" data-vertical="true" data-asnavfor="#product-images" data-disablepadding="true"><?php
