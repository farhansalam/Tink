		...
		<?php else : ?>
			...
			<?php if ( is_cart() ) : ?>
				...
				<?php echo apply_filters( 'woocommerce_cart_no_shipping_available_html',
					...
					sprintf( __( 'Sorry, shipping is unavailable %s.','bronx' ) . ' ' . __( 'If you require assistance or wish to make alternate arrangements please contact us.','bronx' ), WC()->countries->shipping_to_prefix() . ' ' . WC()->countries->countries[ WC()->customer->get_shipping_country() ] ) .
					'</p></div>'
				); ?>
