...
<div class="small-12 small-centered medium-6 large-4 columns">
	<div class="text-center"><h3><?php echo apply_filters( 'woocommerce_my_account_my_subscriptions_title', __( 'My Subscriptions','bronx' ) ); ?></h3></div>
	...
	<table class="shopping_bag">
		...
		<thead>
			<tr>
				...
				<th class="order-actions"><span class="nobr"><?php _e( 'Actions', 'bronx' ); ?></span></th>
			</tr>
		</thead>
